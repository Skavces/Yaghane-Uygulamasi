        ...
        <div className="text-center opacity-80">
          <div className="inline-flex items-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center justify-center p-3 rounded-full bg-white/70 border border-slate-200 shadow-sm backdrop-blur-sm text-slate-500 hover:text-emerald-600 hover:border-emerald-300 transition-all"
              title="Ayarlar"
            >
